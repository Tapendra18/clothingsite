    ...
    <>
      <header className="header-area header-style-1 header-style-5 header-height-2">
        ...
        <div
          className={
            colors
              ? " header-scroll-bg header-bottom-bg-color"
          ...
          <div className="container">
            <div className="header-wrap header-space-between position-relative">
              <div className="logo logo-width-1 d-block d-lg-none">
                <a href="/">
                  <img
                    src="media/site_logo/imgs/logo_VKBBW51_1.png"
                    alt="Nest"
                  />
                </a>
              </div>
                    ...
                    <div className="search-style-2">
                      <form action="productsearch" method="post">
                        ...
                        <select
                          ...
                          className="select-active  category-search"
                          id="category-search"
                        >
                          <option>All Categories</option>
                          <option>Food &amp; Beverage</option>
                    ...
                    <div className="header-action-icon-2">
                      ...
                      <div className="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                        <ul>
                          ...
                          <li>
                            <a href="/register">
                              <i className="fi fi-rs-user-add mr-10"></i>
                              Register
                            </a>
                          </li>
                        </ul>
        ...
        <div className="mobile-header-wrapper-inner">
          <div className="mobile-header-top">
            <div className="mobile-header-logo">
              <a href="/">
                <img src="media/site_logo/imgs/logo_VKBBW51_1.png" alt="Nest" />
              </a>
            </div>
          ...
          <div className="mobile-header-content-area">
                ...
                <ul className="mobile-menu font-heading">
                  ...
                  <li className="menu-item-has-children">
                    ...
                    <ul className="dropdown">
                      ...
                      <li className="menu-item-has-children">
                        <a href="/shop/super/beauty-fragrances">
                          Beauty &amp; Fragrances
                        </a>
                        <ul className="dropdown">
                          <li>
                      ...
                      <li className="menu-item-has-children">
                        <a href="/shop/super/home-furniture">
                          Home &amp; Furniture
                        </a>
                        <ul className="dropdown">
                          <li>
                      ...
                      <li className="menu-item-has-children">
                        <a href="/shop/super/health-personal-care">
                      ...
                      <li className="menu-item-has-children">
                        <a href="/shop/super/construction-hardware">
                      ...
                      <li className="menu-item-has-children">
                        <a href="/shop/super/sports-fitness">
                          Sports &amp; Fitness
                        </a>
                        <ul className="dropdown">
                          <li>
            ...
            <div className="mobile-header-info-wrap">
              <div className="single-mobile-header-info">
                <a href="/contact/">
                  <i className="fi-rs-marker"></i>Contact
                </a>
              </div>
              <div className="single-mobile-header-info">
                <a href="/login/">
            ...
            <div className="site-copyright">
              Copyright 2022 © store. All rights reserved. Powered by
              apexcode.info.
            </div>
          </div>
        </div>
      </div>
      <div id="alert-container" className="not-visible"></div>
    </>
  );
}
