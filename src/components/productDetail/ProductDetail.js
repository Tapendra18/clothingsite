                ...
                <div className="page-header breadcrumb-wrap">
                    <div className="container">
                        <div className="breadcrumb">
                            ...
                            <span></span> <a href="/shop/super/automotive">Automotive</a> <span></span> Seeds of Change Organic
                        </div>
                    </div>
                </div>
                                                ...
                                                <div className="detail-info pr-30 pl-30">
                                                    ...
                                                    <div className="clearfix product-price-cover">
                                                        <div className="product-price primary-color float-left">
                                                            <span className="current-price text-brand">USD13.0</span>
                                                            <span>
                                                    ...
                                                    <div className="short-desc mb-30">
                                                        <p className="font-lg"><p>Haagen-Dazs Caramel Cone Ice Cream Ketchup</p>.</p>
                                                    </div>
