                        ...
                        <div className="archive-header">
                            <div className="row align-items-center">
                                <div className="col-xl-3">
                                    <h1 className="mb-15">Beauty &amp; Fragrances</h1>
                                    <div className="breadcrumb">
                                        <a href="/" rel="nofollow"><i className="fi-rs-home mr-5"></i>Home</a>
                                        <span></span> Shop <span></span> Beauty &amp; Fragrances
                                    </div>
                                </div>
                        ...
                        <div className="categories-dropdown-wrap col-lg-1-5 primary-sidebar sticky-sidebar">
                            <div className="sidebar-widget widget-category-2 mb-30">
                                ...
                                <ul className="ul-category">
                                    <li value="25">
                                        <a href="/shop/main/makeup"> <img src="media/categories/main/imgs/5060346f5bb533952f5b493fce8ef8d6.webp" alt="Makeup" />Makeup</a>
                                    </li>
                                </ul>
                            </div>
...
export default BeautyFragances