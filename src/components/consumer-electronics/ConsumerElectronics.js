                        ...
                        <div className="archive-header">
                            <div className="row align-items-center">
                                <div className="col-xl-3">
                                    <h1 className="mb-15">Consumer Electronics</h1>
                                    <div className="breadcrumb">
                                        <a href="/" rel="nofollow"><i className="fi-rs-home mr-5"></i>Home</a>
                                        <span></span> Shop <span></span> Consumer Electronics
                                    </div>
                                </div>
                        ...
                        <div className="categories-dropdown-wrap col-lg-1-5 primary-sidebar sticky-sidebar">
                            <div className="sidebar-widget widget-category-2 mb-30">
                                ...
                                <ul className="ul-category">
                                    <li value="27">
                                        <a href="/shop/main/mobile-phones-tablets"> <img src="media/categories/main/imgs/034fdb3fb17a294dfe7bf82b50877fac.webp" alt="Mobile Phones &amp; Tablets" />Mobile Phones &amp; Tablets</a>
                                    </li>
                                </ul>
                            </div>
