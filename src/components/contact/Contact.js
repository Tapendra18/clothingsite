...
import { contactAPI } from '../../store/slices/contactSlice';
...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		if (name === "") {
			...
			toast.error("Enter Your Valid  phone ");
		} else if (subject === "") {
			toast.error("Enter Your Valid subject");
		} else if (message === "") {
			toast.error("Enter Your Valid message");
		} else if (!email.includes("@")) {
			toast.error("missing @");
		} else if (!phone.match('[0-9]{10}')) {
			toast.error("Enter number valid please")
		}else{
			dispatch(contactAPI(data));
			toast.success("your feedback submit");
		}
	}
												...
												<div className="row">
													<div className="col-lg-6 col-md-6">
														<div className="input-style mb-20">
															<input name="name" placeholder="First Name" type="text" onChange={handleChange}
															/>
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="input-style mb-20">
															<input name="email" placeholder="Your Email" type="email" onChange={handleChange}
															/>
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="input-style mb-20">
															<input name="phone" placeholder="Your Phone" type="tel" onChange={handleChange}
															/>
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="input-style mb-20">
															<input name="subject" placeholder="Subject" type="text" onChange={handleChange}
															/>
														</div>
													</div>
