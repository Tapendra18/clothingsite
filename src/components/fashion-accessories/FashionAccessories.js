                        ...
                        <div className="archive-header">
                            <div className="row align-items-center">
                                <div className="col-xl-3">
                                    <h1 className="mb-15">Fashion &amp; Accessories</h1>
                                    <div className="breadcrumb">
                                        <a href="/" rel="nofollow"><i className="fi-rs-home mr-5"></i>Home</a>
                                        <span></span> Shop <span></span> Fashion &amp; Accessories
                                    </div>
                                </div>
                        ...
                        <div className="categories-dropdown-wrap col-lg-1-5 primary-sidebar sticky-sidebar">
                            <div className="sidebar-widget widget-category-2 mb-30">
                                ...
                                <ul className="ul-category">
                                    <li value="28">
                                        <a href="/shop/main/clothing"> <img src="/media/categories/main/imgs/Books_c4668124e2_1.webp" alt="Clothing" />Clothing</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                ...
                                <div className="single-post clearfix">
                                    <div className="image">
                                        <img src="/media/products/imgs/product-2-1.jpg" style={{width:"80px",height:"80px"}} alt="#" />
                                    </div>
                                    <div className="content pt-10">
