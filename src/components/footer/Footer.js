                        ...
                        <div className="col-lg-12">
                            <div className="position-relative newsletter-inner">
                                <div className="newsletter-content">
                                    ...
                                    <p className="mb-45">Start You'r Daily Shopping with <span className="text-brand">Nest</span>
                                    </p>
                                    <form method="POST" className="form-subcriber d-flex selector-2">
                                        <input type="hidden" name="csrfmiddlewaretoken"
                                            value="ybcHhIxigLu3GxPKry6eKHTWkWAMYiw0LEuKuoBalMF1AYpnFCl2ryWAjqfZI8AP" />
                                        <input id="subscribe-input-2" type="email" placeholder="Your emaill address"
                                            required />
                                        <button className="btn" type="submit">Subscribe</button>
                                    </form>
                                </div>
                                <img src="media/site_logo/imgs/banner-9.png" alt="newsletter" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container pt-15 pb-20">
                        ...
                        <div className="col">
                            <div className="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                                ...
                                <div className="logo mb-30">
                                    <a href="/" className="mb-15"><img src="media/site_logo/imgs/logo_VKBBW51_1.png"
                                        alt="Nest" /></a>
                                    <p className="font-lg text-heading"></p>
                                </div>
                                <ul className="contact-infor">
                                    <li><img src="static/assets/imgs/theme/icons/icon-location.svg"
                                        alt="" /><strong>Address: </strong> <span>205 North Michigan Avenue, Suite 810
                                            Chicago, 60601, USA</span></li>
                                    <li><img src="static/assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call
                                        Us:</strong><span>(123) 456-7890</span></li>
                                    <li><img src="static/assets/imgs/theme/icons/icon-email-2.svg"
                                        alt="" /><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection"
                                            className="__cf_email__"
                                            data-cfemail="b4d7dbdac0d5d7c0f4f1c2d5c6d59ad7dbd9">[email&#160;protected]</a></span>
                                    </li>
                                    <li><img src="static/assets/imgs/theme/icons/icon-clock.svg"
                    ...
                    <div className="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp"
                            ...
                            <div className="download-app">
                                ...
                                <a href="#" className="hover-up mb-sm-2"><img src="static/assets/imgs/theme/google-play.jpg"
                                    alt="" /></a>
                            </div>
            ...
            <div className="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                <div className="row align-items-center">
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6">
                        <p className="font-sm mb-0">&copy; 2022, <strong className="text-brand">Nest</strong> - All rights reserved
                        </p>
                    </div>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                        <div className="mobile-social-icon">
                            ...
                            <a href="https://www.youtube.com/"><img
                                src="static/assets/imgs/theme/icons/icon-youtube-white.svg" alt="" /></a>
                        </div>
